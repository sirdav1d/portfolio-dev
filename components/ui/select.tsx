...
>(({ className, children, position = 'popper', ...props }, ref) => (
	<SelectPrimitive.Portal>
		<SelectPrimitive.Content
			ref={ref}
			className={cn(
				'relative z-50 min-w-32 overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
				position === 'popper' &&
		...
		<span className='mr-2.5 flex h-3.5 w-3.5 shrink-0 items-center justify-center'>
			<SelectPrimitive.ItemIndicator>
				<svg
					...
					<path
						fillRule='evenodd'
						d='M16.704 5.29a1 1 0 0 1 .005 1.414l-8 8a1 1 0 0 1-1.414 0l-4-4a1 1 0 0 1 1.414-1.414L8 12.586l7.296-7.297a1 1 0 0 1 1.408-.005Z'
						clipRule='evenodd'
					/>
				</svg>
			</SelectPrimitive.ItemIndicator>
