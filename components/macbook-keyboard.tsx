...
const MacBookKeyboard = () => {
	return (
		<div>
			<div className='flex flex-row items-center justify-center gap-10 max-w-352 mx-auto  w-full'>
				<div className='absolute md:relative rounded-md bg-zinc-800 p-1 translate-y-14 scale-[0.9] sm:scale-[1.5] md:scale-[1.7] w-fit h-fit mx-auto'>
					<div className='flex gap-[2px] mb-[2px] w-full shrink-0'>
						<div className='p-[0.5px] rounded-[4px] bg-white/20 shadow-md shadow-white/50 hover:shadow-none hover:scale-[0.98] cursor-pointer transition duration-100'>
							<div
